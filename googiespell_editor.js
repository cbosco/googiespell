...
function GoogieSpell(img_dir, server_url) {
    ...
    this.edit_layer_ready_observer = null;
    this.error_window_ready_observer = null;
...
GoogieSpell.prototype.showErrorWindow = function(elm, id) {
    ...
    if (this.error_window_ready_observer)
      this.error_window_ready_observer(this);
}
...
GoogieSpell.prototype.createEditLayer = function(width, height) {
    this.edit_layer = this.createInFrame ? this.createInFrame('div', 'googie_edit_layer') : AJS.DIV({'class': 'googie_edit_layer'});
    ...
    if (this.edit_layer_ready_observer)
      this.edit_layer_ready_observer(this);
...
GoogieSpell.prototype.createErrorLink = function(text, id) {
    var elm = this.createInFrame ? this.createInFrame('span', 'googie_link') : AJS.SPAN({'class': 'googie_link'});
    var me = this;
    var d = function (e) {
...
//	HTML support
//	Inserts error links into output while retaining full Googie error object
...
GoogieSpell.prototype.showErrorsInIframe = function() {
    var output = this.createInFrame ? this.createInFrame('div') : AJS.DIV();
